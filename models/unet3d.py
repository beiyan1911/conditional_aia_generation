...
class Decoder(nn.Module):
    def __init__(self, in_channels, out_channels, bias=True, batchNorm=True, affine=False):
        ...
        self.deconv1 = nn.ConvTranspose3d(in_channels, in_channels // 2, kernel_size=(3, 3, 3), stride=(1, 2, 2),
...
class UNet3D(nn.Module):
    def __init__(self, input_dim=5, out_channels=1, n_feat=8, bias=True, batchNorm=True, affine=False):
        self.in_channel = 1
        ...
        self.cout = nn.Conv3d(n_feat, out_channels, kernel_size=(input_dim, 3, 3), stride=(1, 1, 1), padding=(0, 1, 1),
                              bias=bias)
...
if __name__ == '__main__':
    x = torch.randn([1, 5, 512, 512], dtype=torch.float32)
